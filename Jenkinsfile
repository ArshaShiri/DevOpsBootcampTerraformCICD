            ...
            steps {
                script {
                    ...
                    sshagent(['server-ssh-key']) {
                        sh "scp -o StrictHostKeyChecking=no server-cmds.sh ec2-user@3.71.176.75:/home/ec2-user"
                        sh "scp -o StrictHostKeyChecking=no docker-compose.yaml ec2-user@3.71.176.75:/home/ec2-user"
